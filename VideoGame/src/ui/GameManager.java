...
public class GameManager {
        ...
        while (exit == false) {
            ...
            switch (election) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    /*System.out.println(controller.informTopPlayers().toString());
                    System.out.println(Arrays.toString(controller.informTopPlayers()));*/
                    System.out.println(Arrays.toString(controller.pruebaTop5()));
                    break;
                default:
                    exit = true;
                    break;
    ...
    public static void informTreasureMonstersInLevel() {
        ...
        System.out.println("La cantidad del enemigo seleccionado es: " + controller.informMonstersTreasuresLevel(idLevel-1));
    }
