...
public abstract class Audio implements Reproducible{
    ...
    public Audio(Audio audioToCopy) {
        this.name = audioToCopy.name;
        this.url = audioToCopy.url;
        this.duration = audioToCopy.duration;
        this.amountReproductions = 1;
        this.author = audioToCopy.author;
    }
    @Override
