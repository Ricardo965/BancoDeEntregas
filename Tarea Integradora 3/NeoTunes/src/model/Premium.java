...
public class Premium extends UserConsumer{
    ...
    @Override//añadir la reproducción a la copia del audio
    public String reproduceAudioFromPlaylist(int idPlaylist, int idAudio) {
        registerListenedAudio(listOfPlaylists.get(idPlaylist).getListOfAudios().get(idAudio));
    ...
    public String reproduceAdquiredAudio(int idAudio) {
        registerListenedAudio(((Audio)listOfAdquiredAudios.get(idAudio).getPurchasedAudio()));
    ...
    public boolean playlistAudioValidation(int idPlaylist) {
        return listOfPlaylists.get(idPlaylist).audioValidation();
    }
    @Override
    public boolean adquiredAudioValidation() {
        return !listOfAdquiredAudios.isEmpty();
    }
